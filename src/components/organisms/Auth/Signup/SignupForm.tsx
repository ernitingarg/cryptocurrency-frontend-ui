...
import { useSignup } from '../../../../hooks/auth/useSignCallback';
import { SignupFormInputs } from '../../../../types/form/login';
...
const SigninForm = ({ className }: Props) => {
  ...
  const { handleSubmit, errors, control } = useForm<SignupFormInputs>();
